...
namespace JoytickInterop
{
    ...
    */
    ...
    public class SDLJoystick
    {
        ...
        [DllImport(DLL_FILE_NAME, CharSet = CharSet.Ansi)]
        private extern static string SDL_JoystickName(int joystick);
        ...
        public static List<string> JoysticName
        {
            get
            {
        ...
        private void GetJoystickInfo()
        {
            ...
            NumHats = SDL_JoystickNumBalls(JoyHandle);
        ...
        public void Update()
		{
            ...
            if (hatPrevState[0] != TempHat && TempHat != (byte)JoysickHatPositions.HAT_CENTERED)
            {
                hatNewpressState[0] = TempHat;
            }
            else
            {
                hatNewpressState[0] = (byte)JoysickHatPositions.HAT_CENTERED;
            }
            hatPrevState[0] = TempHat;

            TempHat = _GetHatHeld(1);
            if (hatPrevState[1] != TempHat && TempHat != (byte)JoysickHatPositions.HAT_CENTERED)
            {
                hatNewpressState[1] = TempHat;
            }
            else
            {
                hatNewpressState[1] = (byte)JoysickHatPositions.HAT_CENTERED;
            }
        ...
        public JoysickHatPositions GetHatHeld(int NumHat)
        {
            return (JoysickHatPositions)SDL_JoystickGetHat(JoyHandle, NumHat);
        }
        public JoysickHatPositions GetHatNewPress(int NumHat)
        {
	        return (JoysickHatPositions)hatNewpressState[0];
        }
